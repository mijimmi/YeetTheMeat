...
station_action = "Add Soy Sauce";
accepted_state = "sliced";    // Only accepts sliced meat
output_state = "soy_sliced";
requires_cooking = false;
spawn_cooldown_max = 0;
...
// Popcorn particles
popcorn_particles = ds_list_create();
popcorn_timer = 0;
